...
namespace ZooAPI.Controllers
{
    public class VetsController : Controller
    {
        ...
        public VetsController(ZooDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Vet vet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Vet vet)
        {
            if (id != vet.Id)
            {
                return NotFound();
